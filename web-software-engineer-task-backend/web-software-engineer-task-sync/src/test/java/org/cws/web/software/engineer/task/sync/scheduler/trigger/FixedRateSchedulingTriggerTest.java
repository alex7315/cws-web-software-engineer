...
class FixedRateSchedulingTriggerTest {
	...
	private static final Instant INITIAL_EXECUTION_INSTANT = LocalDateTime.parse("2025-01-01T01:01:00", ISO_DATE_TIME)
	...
	void schuldReturnExecutionTimeGreaterThenLastActualExecution() {
		...
		TriggerContext triggerContext = new SimpleTriggerContext(INITIAL_EXECUTION_INSTANT, INITIAL_EXECUTION_INSTANT,
				INITIAL_EXECUTION_INSTANT);
		assertThat(trigger.nextExecution(triggerContext))
				.isAfterOrEqualTo(INITIAL_EXECUTION_INSTANT.plusSeconds(SCHEDULING_RATE_IN_SECONG));
	}
}
