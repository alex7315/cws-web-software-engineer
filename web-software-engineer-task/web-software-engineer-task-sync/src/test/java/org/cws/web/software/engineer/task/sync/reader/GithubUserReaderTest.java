...
@SpringBootTest(properties = { "cws.github.authorization.token=authToken",
        ...
        "cws.github.user.page.size=2",
        "cws.github.user.count.max=4"
        })
...
class GithubUserReaderTest {
	...
	void shouldReadAllUsers() throws Exception {
		String usersPage1 = objectMapper
				.writeValueAsString(Arrays.asList(new GithubUserDTO("user_1", "1"), new GithubUserDTO("user_2", "2")));
		String usersPage2 = objectMapper
				.writeValueAsString(Arrays.asList(new GithubUserDTO("user_3", "4"), new GithubUserDTO("user_4", "4")));
